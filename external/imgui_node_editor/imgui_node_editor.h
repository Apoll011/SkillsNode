...
struct Style
{
    ...
    Style()
    {
        ...
        PinArrowWidth            = 0.0f;
        GroupRounding            = 10.0f;
        GroupBorderWidth         = 4.0f;
        HighlightConnectedLinks  = 0.0f;
        SnapLinkToPinDir         = 0.0f;

        Colors[StyleColor_Bg]                 = ImColor( 0,  0,  0, 200);
        Colors[StyleColor_Grid]               = ImColor(255, 255, 255,  40);
        Colors[StyleColor_NodeBg]             = ImColor( 32,  32,  32, 200);
        Colors[StyleColor_NodeBorder]         = ImColor(255, 255, 255,  60);
        Colors[StyleColor_HovNodeBorder]      = ImColor( 80, 103, 177, 255);
        Colors[StyleColor_SelNodeBorder]      = ImColor(255, 104,  18, 255);
        Colors[StyleColor_NodeSelRect]        = ImColor(  49, 56, 53,  120);
        Colors[StyleColor_NodeSelRectBorder]  = ImColor(  5, 130, 255, 128);
        Colors[StyleColor_HovLinkBorder]      = ImColor( 0, 255, 255, 100);
        Colors[StyleColor_SelLinkBorder]      = ImColor(255, 255,  0, 145);
        ...
        Colors[StyleColor_PinRect]            = ImColor( 51, 46, 40, 124);
